function [ht_es, BIC] = func_1bLR_RELAX_knownsigma2(z_bar, X, Nr, Nt, Ns, K, t_bar, Pn, N_max, aoa_true, aod_true, H_true)
...
ht = fft2(Ht_hat, N_theta, N_varphi);
...
path_number = 1;
% tic
[aoa_refine aod_refine alpha_r_refine alpha_i_refine loglihood]=f_sigma_newton_refine(aoa_x(path_number),aod_y(path_number),Nr,Nt,K,z_bar,X,t_bar, sigma_v);
